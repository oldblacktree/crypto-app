    ...
    <div className="coin-details">
      <div className="coin-details__header">
        ...
        <img
          src={coin?.iconUrl}
          alt="logo"
          className="coin-details__header-logo"
        />
      </div>
      <p className="coin-details__title paragraph">
        {coin?.name} live price in US Dollar (USD). View value statistics,
        market cap and supply.
      </p>
      <Select
        defaultValue="7d"
        className="coin-details__select"
      ...
      <div className="coin-info">
        <div className="coin-info__item">
          <h3 className="coin-info__item-header section-title3">
        ...
        <div className="coin-info__item">
          ...
          <p className="coin-info_item-description paragraph">
            {coin?.description}
          </p>
        </div>
        <div className="coin-info__item">
          ...
          <div className="coin-info__stats">
            {coin?.links?.map((link) => (
              <div className="coin-info__stats-item paragraph" key={link.name}>
                ...
                <a
                  href={link.url}
                  className="link coin-info__stats-link"
                  target="_blank"
                >
                  {link.name}
                </a>
